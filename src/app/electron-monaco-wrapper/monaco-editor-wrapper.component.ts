import { Component, Input, Output, EventEmitter, OnInit, ViewChild, ElementRef, forwardRef, NgZone, AfterViewInit } from '@angular/core';
...
export class MonacoEditorWrapperComponent implements AfterViewInit, ControlValueAccessor {
